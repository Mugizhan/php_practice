...
<img SRC="../image/icons/rocket.png" width="60" height="45" class="home"><h1 class="home1">ISSUED</h1>
<li>
    ...
    <?php
        ...
        $query="SELECT report.accno,report.regno,books.book,report.issue_date,report.return_date FROM report,books where report.status='not returned' and books.accno=report.accno ";
