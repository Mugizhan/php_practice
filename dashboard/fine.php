...
<img SRC="../image/icons/thumbsdown.png" width="60" height="45" class="home"><h1 class="home1">FINE</h1>
<li>
    ...
    <?php
        ...
        $query="SELECT * FROM report,books where report.accno=books.accno AND report.status='returned'";
        ...
        if($numrow>0)
        {
         ...
         echo '<th>Delayed date</th>';
         echo '<th>Fine amount in INR</th>';
         echo '</tr>';
