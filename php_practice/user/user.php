<html>
    ...
    <body>
        ...
        <img src="../user/images/APJ-removebg-preview.png" width="1000" height="650" class="apj">
        <font class="qoutes">"One Best Book Is Equal To Hundred Good Friends<br>But One Good Friend Is Equal To A Library..."</font>
        <a href="#"><img src="" width="13" height="13"> HOME</a>
        <a href="../user/book.php"><img src="" width="13" height="13"> BOOKS</a>
        <a href="../user/search.php"><img src="" width="13" height="13"> SEARCH</a>
        <a href="../user/magazine.php"><img src="" width="13" height="13"> MAGAZINE</a>
